#--------- Flask settings
SERVER_HOST = 'https://neighborly-ninja.azurewebsites.net' # Update this for the appropriate front-end website when up
SERVER_PORT = 5000
...
API_URL = "https://neighborlyfunctionninja.azurewebsites.net/api"
